...
export class CommonService {
    ...
    doFlash(deviceCode: string) {
        return this.service.sendRequestWithLog(CHANNEL_ID_RR_NOTICELIGHT, 'flash', {'device': deviceCode});
    }

    doOff(deviceCode: string) {
        return this.service.sendRequestWithLog(CHANNEL_ID_RR_NOTICELIGHT, 'lightoff', {'device': deviceCode});
    }
